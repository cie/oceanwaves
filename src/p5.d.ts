...
declare class p5 {}
   ...
   */
  declare function constructor(sketch: Function, node?: HTMLElement|boolean, sync?: boolean): void
   ...
   *
   */
  declare var RADIANS: 'radians'
  declare var CORNER: 'corner'
  declare var CORNERS: 'corners'
  declare var RADIUS: 'radius'
  declare var RIGHT: 'right'
  declare var LEFT: 'left'
  declare var CENTER: 'center'
  declare var TOP: 'top'
  declare var BOTTOM: 'bottom'
  declare var BASELINE: 'alphabetic'
  declare var POINTS: 0x0000
  declare var LINES: 0x0001
  declare var LINE_STRIP: 0x0003
  declare var LINE_LOOP: 0x0002
  declare var TRIANGLES: 0x0004
  declare var TRIANGLE_FAN: 0x0006
  declare var TRIANGLE_STRIP: 0x0005
  declare var QUADS: 'quads'
  declare var QUAD_STRIP: 'quad_strip'
  declare var CLOSE: 'close'
  declare var OPEN: 'open'
  declare var CHORD: 'chord'
  declare var PIE: 'pie'
  declare var PROJECT: 'square'
  declare var SQUARE: 'butt'
  declare var ROUND: 'round'
  declare var BEVEL: 'bevel'
  declare var MITER: 'miter'
  declare var RGB: 'rgb'
  declare var HSB: 'hsb'
  declare var HSL: 'hsl'
  declare var BLEND: 'source-over'
  declare var ADD: 'lighter'
  declare var DARKEST: 'darkest'
  declare var LIGHTEST: 'lighten'
  declare var DIFFERENCE: 'difference'
  declare var EXCLUSION: 'exclusion'
  declare var MULTIPLY: 'multiply'
  declare var SCREEN: 'screen'
  declare var REPLACE: 'copy'
  declare var OVERLAY: 'overlay'
  declare var HARD_LIGHT: 'hard-light'
  declare var SOFT_LIGHT: 'soft-light'
  declare var DODGE: 'color-dodge'
  declare var BURN: 'color-burn'
  declare var THRESHOLD: 'threshold'
  declare var GRAY: 'gray'
  declare var OPAQUE: 'opaque'
  declare var INVERT: 'invert'
  declare var POSTERIZE: 'posterize'
  declare var DILATE: 'dilate'
  declare var ERODE: 'erode'
  declare var BLUR: 'blur'
  declare var NORMAL: 'normal'
  declare var ITALIC: 'italic'
  declare var BOLD: 'bold'
  declare var LANDSCAPE: 'landscape'
  declare var PORTRAIT: 'portrait'
